...
export default (()=>{
    ...
    let scoped_method={
        ...
        initLight(){
            scoped.Light = new SpotLight(0xffffff,0.5);
    ...
    function  GLBIM(){
        ...
        this.destroy = ()=>{
            ...
            this.domElement.removeChild(document.querySelector('.glbim-container'))
            this.scene = null;
            scoped.camera = null;
        ...
        this.load = (uri) => {
            ...
            let progressEl = document.querySelector('.glbim-progress');
        ...
        this.loadModel = (obj)=>{
            ...
            scoped.Light.position.set(max.x / 2, max.y + max.y * 1.2, max.z - (max.z * 2));
    ...
    GLBIM.prototype.transparentComponentsById = actions.transparentComponentsById;
    GLBIM.prototype.setComponentsColorById = actions.setComponentsColorById;
    GLBIM.prototype.clearComponentsColorById = actions.clearComponentsColorById;
    GLBIM.prototype.setWorldPosition = actions.setWorldPosition;
    GLBIM.prototype.removeWorldPosition = actions.removeWorldPosition;
    GLBIM.prototype.Color = actions.GLColor;
    return  GLBIM;
})();
